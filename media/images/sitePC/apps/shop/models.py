...
class Subcategory(models.Model):
    ...
    name = models.CharField("Название", max_length=50)
    check_to_buy = models.CharField("Проверка возможности", max_length=50, default="-",
                                    help_text="have - имеет ли игрок permission. have_more - имеет ли игрок "
                                              "permission, который выше других")
